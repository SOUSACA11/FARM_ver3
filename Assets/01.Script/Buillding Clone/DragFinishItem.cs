...
public class DragFinishItem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    private void Start()
    {
        //카메라의 DragAndDropCamera 스크립트 얻기
        cameraDragScript = Camera.main.GetComponent<DragAndDropCamera>();

        //IngredientManagerUI 참조 설정 (만약 IngredientManagerUI가 같은 오브젝트에 있으면)
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        clonedImage.transform.SetAsLastSibling();  
        ...
        //IngredientManagerUI의 ProductImageClicked 호출
